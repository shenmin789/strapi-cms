...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    author: Attribute.Relation<
      ...
      'api::author.author'
    >;
    cover_alt_text: Attribute.Text;
    thumbnail_alt_text: Attribute.Text;
    seo_term: Attribute.UID<'api::blog.blog', 'title'> &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    tags: Attribute.Relation<'api::blog.blog', 'oneToMany', 'api::tag.tag'>;
    sections: Attribute.Component<'blog.section', true>;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    seo_term: Attribute.UID<'api::category.category', 'name'> &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    createdAt: Attribute.DateTime;
...
export interface ApiFaqFaq extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    seo_term: Attribute.UID<'api::faq.faq', 'question'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiFaqCategoryFaqCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    seo_term: Attribute.UID<'api::faq-category.faq-category', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSettingSetting extends Schema.CollectionType {
  ...
  attributes: {
    blog_title: Attribute.String &
      Attribute.DefaultTo<'Updates, stories, and announcements from Henjin.'>;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    seo_term: Attribute.UID<'api::tag.tag', 'name'> &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    createdAt: Attribute.DateTime;
